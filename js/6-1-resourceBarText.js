...
function create(){
	...
	game.time.events.loop(Phaser.Timer.SECOND*2, o_2_XX__t_1_XX_Listener, this);
...
function update(){
	...
	r_2_XX_=r_2_XX_+1*this.game.time.elapsed/3840.0;
...
function o_3_XX_NotOverlapHandler(){
	r_2_XX_=r_2_XX_-3/2;
...
function o_3_XX_PressedHandler(){
	if(!game.physics.arcade.overlap(addedEntities['e_1_XX_'], addedEntities['e_2_XX_'], null, null, this)){
	o_3_XX_NotOverlapHandler();
	}
};
