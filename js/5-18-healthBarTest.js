...
function create(){
	...
	game.time.events.loop(Phaser.Timer.SECOND*1, pingpong_entity_e_1_XX__XX__XX__pingpong_entity_e_1_XX_Listener, this);
...
function update(){
	...
	game.physics.arcade.overlap(addedEntities['e_1_XX_'],addedEntities['e_1_XX_'],o_1_XX_OverlapHandler,null, this);
	game.physics.arcade.overlap(addedEntities['e_1_XX_'],addedEntities['e_2_XX_'],o_4_XX_OverlapHandler,null, this);
	addedEntities['e_1_XX_'].forEach(function(item){
		item.inputEnabled=true;
		item.events.onInputDown.add(o_6_XX__e_1_XX_ClickListener,this);
	}, this);

	if(r_2_XX_<=4){
		addedEntities['e_1_XX_'].forEach(function(item) {
		addedEntities['e_1_XX_'].forEach(function(item2) {
...
function o_1_XX_OverlapHandler(e1,e2){
	...
	r_2_XX_=r_2_XX_+2*this.game.time.elapsed/10000.0;
...
function o_4_XX_OverlapHandler(e1,e2){
...
function o_6_XX__e_1_XX_ClickListener(){
	r_2_XX_=r_2_XX_-3;

		
};

function pingpong_entity_e_1_XX__XX__XX__pingpong_entity_e_1_XX_Listener(){
